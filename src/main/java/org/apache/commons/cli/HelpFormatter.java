...
public class HelpFormatter
{
    ...
    private void appendOption(StringBuffer buff, Option option, boolean required)
    {
        ...
        if (option.hasArg() && (option.getArgName() == null || option.getArgName().length() != 0))
        {
            ...
            buff.append(option.getArgName() != null ? option.getArgName() : getArgName()); // MODIFIED
        }
    ...
    protected StringBuffer renderOptions(StringBuffer sb, int width, Options options, int leftPad, int descPad)
    {
        ...
        for (Option option : optList)
        {
            ...
            else
            {
                ...
                if (option.hasLongOpt())
                {
                    ...
                    optBuf.append(", ").append(getLongOptPrefix()).append(option.getLongOpt()); // MODIFIED
                }
            }
            ...
            if (option.hasArg())
            {
                ...
                else
                {
                    ...
                    optBuf.append(argName != null ? option.getArgName() : getArgName()); // MODIFIED
                }
            }
        ...
        for (Iterator<Option> it = optList.iterator(); it.hasNext();)
        {
            ...
            nextLineTabStop = 5; // ADDED

            if (option.getDescription() != null)
            {
                optBuf.append(getNewLine());
                optBuf.append(option.getDescription()); // ADDED
            }
