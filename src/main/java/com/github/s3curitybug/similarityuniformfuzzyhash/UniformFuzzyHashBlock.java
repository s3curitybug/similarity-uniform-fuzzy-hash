...
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_CHAR_BITS;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_CHAR_ENCODER;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_ESCAPABLE_CHARS;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_ESCAPE_CHAR;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_INT_CHARS_ENCODER;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_INT_CHARS_SHIFT_BITS;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.ASCII_INT_MAX_CHARS;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.BLOCK_INNER_SEPARATOR;
import static com.github.s3curitybug.similarityuniformfuzzyhash.ToStringUtils.HEX_BLOCK_MAX_CHARS;
